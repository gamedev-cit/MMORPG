export default class TextInput extends PIXI.Container {
	...
	_canvas_bounds: any
	_box: any
	_surrogate_hitbox: PIXI.Graphics | null = new PIXI.Graphics()
	_surrogate_mask: PIXI.Graphics | null = new PIXI.Graphics()
	_font_metrics: any
	...
	_updateSurrogateMask(bounds: any, padding: any){
...
function DefaultBoxGenerator(styles: any){
	...
	return function(w: number, h: number, state: any){
